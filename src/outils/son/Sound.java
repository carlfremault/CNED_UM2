 ...
 * Si le son ne sera plus utilis�, il faut le d�truire par la m�thode fermer,
 * <br>
...
public class Sound implements Serializable, Runnable {
	...
	// fermerALaFin : indique si le son doit �tre d�truit une fois la derni�re
	// boucle de son ex�cut�e
	...
	private void initialise(File fichier) throws SonException {
		try {
			...
			// On cr�e une information avec le format du flux et en caculant la logueneur
			// totale du son
	...
	/**
	 * Action du son, ne jamais appel� cette m�thode directement, elle est public
	 * pour respecter l'impl�mentation de Runnable
	 */
	public void run() {
	 ...
	 * 
	 * @param fermer <b>true</b> pour indiqu� que l'on d�sire que le son soit
	 *               d�truit apr�s la derni�re fois qu'il joue
	 */
