...
/**
 * Gestion d'un serveur : cr�ation d'une connexion de type serveur pour attendre
...
public class ServeurSocket extends Thread {
	...
	public ServeurSocket(AsyncResponse delegate, int port) {
		...
		try {
			...
			// le d�marrage de l'�coute ne peut se faire que si un objet delegate existe
	...
	public void run() {
		...
		while (true) {
			try {
				...
				// cr�ation d'une connexion vers ce client, pour la communication (envoi et
				// r�ception d'informations)
