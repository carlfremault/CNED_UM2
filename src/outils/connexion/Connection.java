...
public class Connection extends Thread {
	...
	/**
	 * objet de lien avec une autre classe qui impl�mente AsyncResponse pour
	 * transf�rer les r�ponses
	 */
	private AsyncResponse delegate;

	/**
	 * Constructeur : cr�e une connexion � partir d'un socket (contenant les
	 * sp�cificit�s de l'ordinateur distant)
	 * 
	 * @param socket   objet de connexion de type serveur ou client
	 * @param delegate instance de la classe vers laquelle il faut transf�rer les
	 *                 r�ponses
	 */
	public Connection(Socket socket, AsyncResponse delegate) {
		...
		this.start();
		// envoi de l'instance de connexion vers la classe qui impl�mente AsyncResponse
		// pour r�cup�rer la r�ponse
	...
	public synchronized void envoi(Object unObjet) {
		// l'envoi ne peut se faire que si un objet delegate existe (pour r�cup�rer la
		// r�ponse)
		if (delegate != null) {
			try {
				this.out.reset();
	...
	public void run() {
		...
		while (inOk) {
			try {
				...
				// envoi de l'information re�ue vers la classe qui impl�mente AsyncResponse pour
				...
				// envoi de l'information de d�connexion vers la classe qui impl�mente
				// AsyncResponse pour r�cup�rer la r�ponse
